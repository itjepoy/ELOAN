    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSignaturePad.setOnSignedListener(new SignaturePad.OnSignedListener() {
            ...
            public void onStartSigning() {
                Toast.makeText(ESignature.this, "Signing", Toast.LENGTH_SHORT).show();
            }
        ...
        mSaveButton.setOnClickListener(view -> {
            ...
            if (addJpgSignatureToGallery(signatureBitmap)) {
                Toast.makeText(ESignature.this, "Signature saved into the Device", Toast.LENGTH_SHORT).show();
            } else {
...
//            }
    ...
    public boolean addJpgSignatureToGallery(Bitmap signature) {
        ...
        try {
            File photo = new File(getExternalFilesDir(null), ClientInformation.lastname_edit_text.getText().toString().concat("_").concat(ClientInformation.firstname_edit_text.getText().toString()).concat("_sig") + ".png");
            //File photo = new File(getAlbumStorageDir("SignaturePad"), String.format("Signature_%d.png", System.currentTimeMillis()));
            saveBitmapToJPG(signature, photo);
            scanMediaFile(photo);
            ClientInformation.appPath.setText(photo.getPath());
            result = true;
        } catch (IOException e) {
            e.printStackTrace();
        }
